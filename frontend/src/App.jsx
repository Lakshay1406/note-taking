...
function App() {
  ...
  return (
    <>
      ...
      <div className="bg-[url('/bookbg2.jpg')] bg-cover bg-center overflow-auto h-screen scrollbar-dark">
        <div className="bg-gradient-to-r from-black/80 from-10% via-transparent to-transparent flex flex-col h-full">
          <NavBar />
